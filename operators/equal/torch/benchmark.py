...
def run_benchmark(batch, warmup, loops, repeat, device_id):
    ...
    elem_size_input = 2
    elem_size_output = 1
    input_bytes = total_elems(batch) * elem_size_input * 2
    output_bytes = total_elems(batch) * elem_size_output
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Torch baseline benchmark for Equal")
    ...
    output = {"results": results, "framework": "torch", "operator": "equal"}

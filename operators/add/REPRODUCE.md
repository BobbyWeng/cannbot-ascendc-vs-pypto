# Reproducing Add (4-Input) Experiment
...
for b in 1 2 4 8 16 32 64; do
  ./ascendc/build/add_ascendc 0 $b 20 8192 1 1 1 data ascendc/build/output
...
## Artifacts
All output files are stored within `operators/add/`. SHA256SUMS at the operator root for integrity verification.

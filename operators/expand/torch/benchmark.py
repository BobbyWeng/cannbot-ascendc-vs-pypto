...
def run_benchmark(batch, warmup, loops, repeat, device_id):
    ...
    for _ in range(warmup):
        _ = x_npu.expand(batch, 256, 384).contiguous()
    ...
    read_bytes = batch * 256 * 1 * 2
    write_bytes = batch * 256 * 384 * 2
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Torch baseline benchmark for Expand")
    ...
    output = {"results": results, "framework": "torch", "operator": "expand"}

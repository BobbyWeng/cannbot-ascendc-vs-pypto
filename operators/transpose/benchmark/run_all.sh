...
ASCENDC_BIN="$ASCENDC_BUILD_DIR/transpose_ascendc"
...
echo "============================================"
echo " Transpose Benchmark Runner"
echo "============================================"
...
echo "[CORRECT] PyPTO..."
python3 "$PYPTO_DIR/tests/test_transpose.py" 2>&1 || true
...
echo " Summary"
echo "============================================"
echo " Operator  : transpose"
echo " Shape     : [B, 256, 384] -> [B, 384, 256]  B in {${BATCHES[*]}}"
echo " Dtype     : float16"
echo " Warmup    : $WARMUP"
echo " Loops     : $LOOPS"
echo " Repeat    : $REPEAT"

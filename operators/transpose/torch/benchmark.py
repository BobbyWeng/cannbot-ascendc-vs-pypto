...
def run_benchmark(batch, warmup, loops, repeat, device_id):
    ...
    for _ in range(warmup):
        _ = x_npu.transpose(1, 2).contiguous()
    ...
    total_bytes = (batch * H * W * 2) + (batch * W * H * 2)  # read + write
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Torch baseline benchmark for Transpose")
    ...
    output = {"results": results, "framework": "torch", "operator": "transpose"}

# Reproducing Or (LogicalOr) Experiment
...
# Ascend C (all batches, random_mask variant)
for b in 1 2 4 8 16 32 64; do
  ./ascendc/build/or_ascendc 0 $b 20 8192 1 1 1 data ascendc/build/output random_mask
  python3 data/generation_scripts/correctness.py ascendc/build/output/output_b${b}.bin data/reference_b${b}_random_mask.bin $b
done

...
ASCENDC_BIN="$ASCENDC_BUILD_DIR/relu_ascendc"
...
echo "[CORRECT] PyPTO..."
python3 "$PYPTO_DIR/tests/test_relu.py" 2>&1 || true
...
echo "============================================"
echo " Operator  : relu"
echo " Shape     : [B, 12, 256, 32]  B in {${BATCHES[*]}}"
echo " Dtype     : float16"
echo " Warmup    : $WARMUP"
echo " Loops     : $LOOPS"
echo " Repeat    : $REPEAT"
